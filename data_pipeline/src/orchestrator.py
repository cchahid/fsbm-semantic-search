...
def setup_proxies():
    print("[*] Configuring ScraperAPI...")
    pg = ProxyGenerator()

    # Replace the string below with your actual ScraperAPI key
    api_key = "d3eef4b67cf0fe6eb2c5e2c298799ae3"

    try:
        success = pg.ScraperAPI(api_key)
        if success:
            scholarly.use_proxy(pg)
            print("[*] ScraperAPI configured successfully! Google will not block you.")
        else:
            print("[!] Warning: Could not configure ScraperAPI. Check your key.")
